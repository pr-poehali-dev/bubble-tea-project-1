          ...
          <div className="space-y-8">
            <div className="bg-card/50 p-8 rounded-2xl border-2 neon-border animate-fade-in">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  Прошли годы. Работа маркетологом, собственные проекты, переезды... Но мечта о кофейне никогда не отпускала. 
                  И вот, летом 2024 года, вместе с Данилой, мы увидели объявление о продаже небольшого помещения в Москве. 
                  Идеальное расположение напротив школы и детского сада, рядом с ВВБ, выгодная аренда — мы поняли, что это наш шанс.
                </p>
              </div>
            </div>
