      ...
      <div className="pt-32 pb-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-center text-muted-foreground mb-16">
            Наслаждайтесь любимыми напитками не выходя из дома
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            <div className="bg-card/50 p-6 rounded-2xl border-2 border-primary/20 hover:neon-border transition-all animate-fade-in">
              ...
              <p className="text-muted-foreground">
                В среднем 30-45 минут в зависимости от вашего адреса и загруженности
              </p>
            </div>
            ...
            <div className="bg-card/50 p-6 rounded-2xl border-2 border-primary/20 hover:neon-border transition-all animate-fade-in" style={{ animationDelay: '0.2s' }}>
              ...
              <p className="text-muted-foreground">
                Картой онлайн, наличными или картой курьеру, Apple Pay, Google Pay
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Экономьте на доставке! А еще не забывайте про счастливые часы с 08:00 до 12:00 (-20%)
                  </p>
                </div>
              </div>
            </div>
